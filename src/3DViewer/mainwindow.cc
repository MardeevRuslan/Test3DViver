...
{
  QString filename_qstring = QFileDialog::getOpenFileName(this, "Choose obj file",
                                                          QDir::homePath(), "*.obj");
...
void MainWindow::On_horizontalSliderTypeLine_actionTriggered(int action)
{
  if (flag_open_ == true)
  {
    ...
    controller_->set_settings("line_width", ui->horizontalSliderTypeLine->value());
    ui->openGLWidget->update();
  }
}
...
void MainWindow::On_horizontalSliderTypeTop_actionTriggered(int action)
{
  if (flag_open_ == true)
  {
    ...
    controller_->set_settings("point_size", ui->horizontalSliderTypeTop->value());
    ui->openGLWidget->update();
  }
}
...
void MainWindow::DataOutputToScreen(std::string filename)
{
  ...
  info.append("\nVertexes: " + QString::number(controller_->get_vertex_count()));
...
void MainWindow::DefaultSettings()
{
  ...
  ui->horizontalSliderTypeTop->setValue(controller_->get_settings("point_size"));
  ui->horizontalSliderTypeLine->setValue(controller_->get_settings("line_width"));
  ui->comboBox_type_top->setCurrentIndex(controller_->get_settings("vertex_display_method"));
  ui->cB_type_line->setCurrentIndex(controller_->get_settings("line_display_method"));
  ui->ProjTypeCombo->setCurrentIndex(controller_->get_settings("type_of_projection"));
}
